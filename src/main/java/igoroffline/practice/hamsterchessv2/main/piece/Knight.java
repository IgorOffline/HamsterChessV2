...
public class Knight {
    ...
    public static MovementAttackOpponentCheck knightMoves(Square knightSquare, Board board) {
        ...
        final var movement1 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.PP_LETTER_NEXT_NUMBER, knightSquare, board);
        final var movement2 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.NN_NUMBER_PREVIOUS_LETTER, knightSquare, board);
        final var movement3 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.NN_NUMBER_NEXT_LETTER, knightSquare, board);
        final var movement4 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.NN_LETTER_NEXT_NUMBER, knightSquare, board);
        final var movement5 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.PP_LETTER_PREVIOUS_NUMBER, knightSquare, board);
        final var movement6 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.PP_NUMBER_PREVIOUS_LETTER, knightSquare, board);
        final var movement7 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.PP_NUMBER_NEXT_LETTER, knightSquare, board);
        final var movement8 =
                FindSquare.findSquare(Piece.KNIGHT, PieceMovement.NN_LETTER_PREVIOUS_NUMBER, knightSquare, board);
